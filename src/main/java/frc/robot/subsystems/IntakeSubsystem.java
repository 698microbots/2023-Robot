...
public class IntakeSubsystem extends SubsystemBase {
   ...
   */
    public IntakeSubsystem() {
      intakeMotorH = new CANSparkMax(Constants.deviceIdIntake1, CANSparkMax.MotorType.kBrushless);
      intakeMotorL = new CANSparkMax(Constants.deviceIdIntake2, CANSparkMax.MotorType.kBrushless);
    }
