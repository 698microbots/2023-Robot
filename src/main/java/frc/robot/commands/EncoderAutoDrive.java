...
public class EncoderAutoDrive extends CommandBase {
  ...
  private int counter, cycleCounter;
  private final double target, timeout;
  public EncoderAutoDrive(DriveTrain driveTrain, double target, navXSubsystem navX, double timeout) {
  ...
  public boolean isFinished() {
    if(counter > 100000 || cycleCounter > timeout/20){
      return true;
    }else{
      return false;
    }
